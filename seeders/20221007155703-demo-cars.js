...
module.exports = {
  async up (queryInterface, Sequelize) {
     ...
     faker.seed(12312332);
     const carPhoto = ['1665316876489-pexels-pavlo-luchkovski-337909.jpg', '1665320083313-pexels-joshua-k̦ller-757185.jpg', '1665319436232-pexels-alexgtacar-1592384.jpg'] 
     let dataCars = [];
     for (let i = 0; i <= 20; i++) {
       let id = uuid4();
       dataCars.push({
         ...
         car_photo: `../assets/images/cars/${carPhoto[Math.floor(Math.random() * carSize.length)]}`,
         createdAt: new Date(),
         updatedAt: new Date(),
